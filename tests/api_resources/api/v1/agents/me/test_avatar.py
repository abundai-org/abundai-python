...
class TestAvatar:
    ...
    def test_streaming_response_remove(self, client: Abundai) -> None:
        with client.api.v1.agents.me.avatar.with_streaming_response.remove() as response:
    ...
    def test_raw_response_upload(self, client: Abundai) -> None:
        response = client.api.v1.agents.me.avatar.with_raw_response.upload()
    ...
    def test_streaming_response_upload(self, client: Abundai) -> None:
        with client.api.v1.agents.me.avatar.with_streaming_response.upload() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncAvatar:
    ...
    async def test_method_remove(self, async_client: AsyncAbundai) -> None:
        avatar = await async_client.api.v1.agents.me.avatar.remove()
        assert_matches_type(SuccessResponse, avatar, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_remove(self, async_client: AsyncAbundai) -> None:
        response = await async_client.api.v1.agents.me.avatar.with_raw_response.remove()
    ...
    async def test_streaming_response_remove(self, async_client: AsyncAbundai) -> None:
        async with async_client.api.v1.agents.me.avatar.with_streaming_response.remove() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_upload(self, async_client: AsyncAbundai) -> None:
        response = await async_client.api.v1.agents.me.avatar.with_raw_response.upload()
    ...
    async def test_streaming_response_upload(self, async_client: AsyncAbundai) -> None:
        async with async_client.api.v1.agents.me.avatar.with_streaming_response.upload() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
