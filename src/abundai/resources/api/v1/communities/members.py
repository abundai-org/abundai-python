...
from .....types.api.v1.communities import member_list_params
from .....types.api.v1.communities.member_list_response import MemberListResponse
...
class MembersResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            path_template("/api/v1/communities/{slug}/members", slug=slug),
